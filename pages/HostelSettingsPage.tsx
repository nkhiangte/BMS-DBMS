...
import { BackIcon, HomeIcon, CogIcon } from '../components/Icons';
    ...
    return (
        <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6 lg:p-8">
            ...
            <div className="text-center py-16">
                <div className="inline-block p-4 bg-gradient-to-br from-teal-400 to-teal-600 text-white rounded-full shadow-lg mb-4">
                    <CogIcon className="w-12 h-12" />
                </div>
                <h1 className="text-3xl font-bold text-slate-800 mt-4">User Roles & Security</h1>
                <p className="text-slate-600 mt-2 text-lg">This feature is currently under development.</p>
                <p className="text-slate-500 mt-1">You will be able to configure hostel-specific user roles and data settings here.</p>
            </div>
        </div>
    );
};
